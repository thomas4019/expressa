...
| GET    | /:collection/?query={}        | get an array of documents matching the [mongo query](https://www.npmjs.com/package/mongo-query). For pagination use `{"skip":0,"offset":0,"limit":6}`.                                         |
